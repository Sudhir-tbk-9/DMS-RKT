...
const CustomerListSelected = () => {
    ...
    const handleConfirmDelete = () => {
        const newCustomerList = userList.filter((customer) => {
        ...
        mutate(
            {
                ...
                total: userListTotal - selectedCustomer.length,
            },
            false,
        )
        setDeleteConfirmationOpen(false)
            ...
            >
                ...
                >
                    {selectedCustomer.map((customer) => (
                        <Tooltip key={customer.id} title={`${customer.firstName} ${customer.lastName}`}>
                            <Avatar size={30} src={customer.image} alt="" />
                        </Tooltip>
                    ))}
                </Avatar.Group>
                <div className="my-4">
