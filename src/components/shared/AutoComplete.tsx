//Yeh ek reusable React component hai jo user ko input field mein type karte waqt suggestions provide karta hai.

//Yeh generic hai, matlab aap ise kisi bhi type ke data ke saath use kar sakte hain.
