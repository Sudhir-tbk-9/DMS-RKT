//jo kisi element ko scroll karte waqt ek fixed position par "stick" kar deta hai. 
// Iska use karke aap kisi element (jaise navigation bar, sidebar, ya buttons) 
// ko page scroll hone par fixed position par display kar sakte hain.
