...
const navigationIcon: NavigationIcons = {
  ...
  orderDetails: <PiListMagnifyingGlassDuotone />,
  ...
  helpCenterSupportHub: <PiHeadsetDuotone />,
  helpCenterArticle: <PiNewspaperDuotone />,
  helpCenterEditArticle: <PiTextIndentDuotone />,
  helpCenterManageArticle: <PiQuotesDuotone />,
  ...
  shareFile: <PiShareNetworkDuotone />,
  dashboardAnalytic: <PiChartBarDuotone />,

  nextNumbering: <PiHashStraightDuotone />,
}
