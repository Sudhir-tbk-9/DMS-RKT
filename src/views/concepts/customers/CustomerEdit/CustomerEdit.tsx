...
const CustomerEdit = () => {
  const { id } = useParams();
  console.log("id to edit in edit component : ", id);
  ...
  const { data, isLoading, error } = useSWR(
    ...
    async ([params]) => {
      ...
      console.log("fetched edit user data : ", data);
  ...
  //         Failed to fetch customer data: {error.data?.message}
  //       </Notification>,
  ...
  //     toast.push(<Notification type="success">Customer deleted!</Notification>, {
  //       placement: "top-center",
  //     });
  //     navigate("/concepts/customers/customer-list");
  //   };
  ...
  const handleConfirmDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await apiDeleteCustomer<{ message: string }, { id: string }>({
        id: id as string,
      });
