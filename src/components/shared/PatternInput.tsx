//  component ka istemal karke pattern-based input formatting provide karta hai.
// Pattern-based formatting ka matlab hai ki input value ko ek specific pattern ke hisab se format kiya jata hai, 
// jaise ki phone numbers ((###) ###-####) ya dates (##/##/####).
