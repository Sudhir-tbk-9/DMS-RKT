// Ek numeric value jo growth/shrinkage ko visually represent karta hai.

// Positive value ke liye green color aur up arrow icon.

// Negative value ke liye red color aur down arrow icon.
