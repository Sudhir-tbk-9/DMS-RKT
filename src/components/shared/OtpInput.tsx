//Yeh component multiple input fields ko render karta hai, jisme har field ek single digit (0-9) accept karta hai.

//User ek digit type karne ke baad automatically next input field mein move ho jata hai.
